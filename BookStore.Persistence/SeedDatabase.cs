...
public static class SeedDatabase
{
    public static IEnumerable<Genre> GetGenres()
    {
        List<Genre> genres =
        [
            new Genre { GenreId = 1, GenreName = "Mystery" },
            new Genre { GenreId = 2, GenreName = "Romance" },
            new Genre { GenreId = 3, GenreName = "Science Fiction" },
            new Genre { GenreId = 4, GenreName = "Fantasy" },
            new Genre { GenreId = 5, GenreName = "Thriller" },
            new Genre { GenreId = 6, GenreName = "Horror" },
            new Genre { GenreId = 7, GenreName = "Historical Fiction" },
            new Genre { GenreId = 8, GenreName = "Biography" },
            new Genre { GenreId = 9, GenreName = "Memoir" },
            new Genre { GenreId = 10, GenreName = "Self-help" },
            new Genre { GenreId = 11, GenreName = "Travel" },
            new Genre { GenreId = 12, GenreName = "Poetry" },
            new Genre { GenreId = 13, GenreName = "Comedy" },
            new Genre { GenreId = 14, GenreName = "Drama" },
            new Genre { GenreId = 15, GenreName = "Crime Fiction" },
            new Genre { GenreId = 16, GenreName = "Action and Adventure" },
            new Genre { GenreId = 17, GenreName = "Children's" },
            new Genre { GenreId = 18, GenreName = "Young Adult" },
            new Genre { GenreId = 19, GenreName = "Paranormal" },
            new Genre { GenreId = 20, GenreName = "Urban Fantasy" },
            new Genre { GenreId = 21, GenreName = "Non-fiction" },
            new Genre { GenreId = 22, GenreName = "Satire" },
            new Genre { GenreId = 23, GenreName = "Western" },
            new Genre { GenreId = 24, GenreName = "Dystopian" },
            new Genre { GenreId = 25, GenreName = "Fairy Tale" },
            new Genre { GenreId = 26, GenreName = "LGBTQ+" },
            new Genre { GenreId = 27, GenreName = "War" },
            new Genre { GenreId = 28, GenreName = "Spiritual" },
            new Genre { GenreId = 29, GenreName = "Philosophy" },
            new Genre { GenreId = 30, GenreName = "Classic" }
        ];
